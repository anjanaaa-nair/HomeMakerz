...
public class GetCabinet : MonoBehaviour
{
    ...
    void Start()
    {
        //StartCoroutine(GetRequest("http://localhost/HomeMakerz/ProductCabinet.php"));
        StartCoroutine(GetRequest("https://homemakerz.000webhostapp.com/ProductCabinet.php"));
    }
