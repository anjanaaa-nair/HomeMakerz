...
public class GetSofa : MonoBehaviour
{
    ...
    void Start()
    {
        //StartCoroutine(GetRequest("http://localhost/HomeMakerz/ProductSofa.php"));
        StartCoroutine(GetRequest("https://homemakerz.000webhostapp.com/ProductSofa.php"));
    }
