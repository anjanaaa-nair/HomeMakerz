...
public class GetMirror : MonoBehaviour
{
    ...
    void Start()
    {
        //StartCoroutine(GetRequest("http://localhost/HomeMakerz/ProductMirror.php"));
        StartCoroutine(GetRequest("https://homemakerz.000webhostapp.com/ProductMirror.php"));
    }
