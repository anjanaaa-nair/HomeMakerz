...
public class GetDecor : MonoBehaviour
{
    ...
    void Start()
    {
        //StartCoroutine(GetRequest("http://localhost/HomeMakerz/ProductDecor.php"));
        StartCoroutine(GetRequest("https://homemakerz.000webhostapp.com/ProductDecor.php"));
    }
