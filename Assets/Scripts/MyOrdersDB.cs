...
public class MyOrdersDB : MonoBehaviour
{
    ...
    void Start()
    {
        //StartCoroutine(GetRequest("http://localhost/HomeMakerz/DisplayMyOrders.php"));
        StartCoroutine(GetRequest("https://homemakerz.000webhostapp.com/DisplayMyOrders.php"));     
   }
